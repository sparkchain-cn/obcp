...
public class PasswordEncoder {
	...
	public boolean check(String encPass, String rawPass) {
	...
	public static void main(String[] args) {
		String salt = "6285c98b-946a-4813-995f-be0bbc76cb3c";
		...
		boolean passwordValid2 = encoderSha.isPasswordValid("083a8db3ff5b9b4ece3ef2bde03226c8", "test");
