...
import cn.obcp.user.Exception.CacheManagerPrincipalIdNotAssignedException;
import cn.obcp.user.Exception.PrincipalIdNullException;
import cn.obcp.user.Exception.PrincipalInstanceException;
import cn.obcp.user.Exception.SerializationException;
import cn.obcp.user.shiro.serializer.ObjectSerializer;
import cn.obcp.user.shiro.serializer.RedisSerializer;
import cn.obcp.user.shiro.serializer.StringSerializer;
