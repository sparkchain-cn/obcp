...
function addTreeNode() {
    openLayer("添加资源",2,'/admin/page/user/resourceAdd.html?parent_id='+node_id,reflushByNodeId);
}
...
function editTreeNode() {
    openLayer("编辑资源",2,'/admin/page/user/resourceAdd.html?id='+node_id,reflushByNodeId);
}
...
function updateNodeParent(dropNodeIdArray,targetNode,moveType) {
    ...
    if (dropNodeIdArray.length > 0){
       ...
       $.post("/v1/resources/updateNodeParent",{dropNodeIds:dropNodeIdArray,parentId:targetId,moveType:moveType},function (response) {
            if (!response.success){
