    ...
    Class.prototype={
        ...
        nodeInit: function(arr,count,spread) {
            ...
            arr.forEach(function(val,index) {
                var hasChild = (!!val.children);
                var content_class = "eleTree-node-content";
                if(hasChild){
                    content_class  += " hasChild"
                }
                var b=['<div class="eleTree-node ',spread?'eleTree-hide':"",'" eleTree-floor="'+count+'">'
                    ,'<div class="'+content_class+'" style="padding-left: '+18*count+'px;">'
                        ,'<span class="eleTree-node-content-icon">'
                            ...
                            ,(function() {
                                ...
                                if(val.children && val.children.length>0){
                                    ...
                                    return '<i class="layui-icon layui-icon-triangle-r" noChild="true" style="color: transparent;"></i>'
                                }
                            })()
                        ,'</span>'
                        // 判断是否启用checkbox
